...
static func generate(
	...
	la_spread *= 1.0 - max(0.0, contact_curve) * _rule_float(rules, "contact_la_control_weight", 0.12) + contact_weakness * _rule_float(rules, "contact_weak_la_spread_weight", 0.08)
	if chase:
