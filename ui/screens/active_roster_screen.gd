...
# 選手登録 画面 (旧「1軍入れ替え」。2026-06-21 モック準拠で再構築 / 全画面ダッシュボード化・D&D 化)。
# 共有基底 dashboard_screen の chrome (サイドバー/ヘッダ/座標系/描画プリミティブ) の上に
#   - 集計カード列 (1軍/投手/野手/捕手/外国人/支配下/育成)
#   - 3 カラム (1軍 / 2軍 / 育成) の選手一覧
#   - 選手詳細 / 今期成績 / コンディション / ロスター影響と注意 の下段パネル
# を構築する。入替操作はカラム間の **ドラッグ&ドロップ** (移動ボタンも併設)。
#
