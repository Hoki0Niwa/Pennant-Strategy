...
ドラフト(入札・抽選つき)、FA(A/B/Cランク・金銭/人的補償・複数年契約)、
...
打順は対右投手・対左投手で別々に保存でき、CPU も相手先発の左右に合わせて
スタメン・DH・打順を組み替えます。
CPUに任せて結果だけ追いかける遊び方もできます。

### 雨天中止・降雨コールド・ノーゲーム

屋外球場の試合は雨で流れます。試合前に中止になれば移動日やシーズン終盤の予備日へ振り替えられ、
試合中に降られた場合は5回以降なら降雨コールドで成立、5回未満ならノーゲームで記録ごと無効になり
後日あらためて最初から行われます。週間予報の降水確率を見ながら、ローテのやりくりと
消化試合数の差を読むことになります。本拠地がドームの球団は中止しません。
...
| 画面 | 役割 |
|---|---|
| ホーム | 本日の試合、直近成績、今後の日程と天気予報、怪我人、各種スキップ操作 |
...
| ファーム情報 | 二軍の3地区制順位表とリーグ全体の集計、二軍成績の選手一覧 |
| シーズン履歴 | 過去年の順位と表彰、歴代記録、タイトル履歴、スタメン履歴 |
| チーム詳細 | 自軍・他球団のロスターとポジション別戦力 |
| 一軍入替 | 31人枠、外国人枠(一軍登録8年で日本人扱い)、育成選手の支配下登録 |
| 打順・守備位置 / 投手起用法 | スタメンと控え、先発ローテ、リリーフの役割(ロング/中継ぎ/セット/抑え) |
| 選手詳細 | 能力、成績、今季試合履歴、月間成績、二軍成績、年俸、契約、経歴 |
| トレード | 自軍からの提案、CPUからの提案への回答、成立トレード一覧 |
| オフシーズン | FA宣言、引退、戦力外、ドラフト、戦力外獲得、現役ドラフト、契約更改、FA、人的補償(プロテクト28人)、契約年数設定、外国人、キャンプ、能力変化 |
| ポストシーズン / 表彰 | CS・日本シリーズ、MVP・新人王・各部門タイトル・ベストナイン・ゴールデングラブ |

## アルファ版について

現在のバージョンは **v0.3.0-alpha** です。
1シーズンから10年以上の長期プレイまで通して動作することは確認していますが、開発中なので想定しない挙動が発生する可能性があります。

- 数値バランスは調整途中です。
- バージョンアップがあると、今のセーブデータが使えなくなることを承知したうえでプレイしてください。

## これから実装したいもの

- ポストシーズン・オフシーズンもカレンダー上で進行させる
- 二軍の拡充(ファーム日本選手権、二軍のタイトル・表彰、二軍の打順エディタ)
- 球団収入モデル(観客動員・成績連動)
- 架空設定としてドラフト権譲渡の追加
- トレードの拡張(オフシーズントレード、複数対1のパッケージ)
- 詳細なFA交渉画面
- 監督就任、監督能力、采配傾向
- スカウト費用・育成費用の概念の導入
- 選手のメジャー挑戦
